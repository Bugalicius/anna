...
- O VPS estava na branch `main` com mudanças locais não commitadas em `/root/agente`; o deploy final preservou essa pasta e subiu a versão final a partir de `/root/agente-v21`.
