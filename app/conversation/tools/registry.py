...
from app.conversation.tools import commands, media, notifications, patients, payments, scheduling
...
TOOLS = {
    ...
    "marcar_confirmacao_dietbox": scheduling.marcar_confirmacao_dietbox,
...
TOOL_INPUT_MODELS: dict[str, type[BaseModel]] = {
    ...
    "marcar_confirmacao_dietbox": scheduling.MarcarConfirmacaoInput,
