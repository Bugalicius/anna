...
from app.conversation.models import AcaoAutorizada, BotaoInterativo, Mensagem, RuleResult, TipoAcao
from app.conversation.output_validator import validar_com_regeneracao
